...
public class NewMailServlet extends HttpServlet {
    ...
    public NewMailServlet() {
        super();
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		System.out.println("....................... New Mail Service .......................");
		BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(request.getInputStream()));
		String json = "";
		if(bufferedReader != null){
			json = bufferedReader.readLine();
		}
		System.out.println("New Mail request JSON : " + json);

		Mail mail = JSONUtil.mapper.readValue(json, Mail.class);

		Response changeMailResponse = new MailDao().newMail(mail);
